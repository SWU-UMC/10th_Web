  ...
  return (
    <div className='flex items-center p-4 border-b border-gray-200'>
      ...
      <div className='flex items-center'>
        <button onClick={handleDecrease} className='px-3 py-1 bg-gray-300 text-gray-800 rounded-l hover:bg-gray-400 cursor-pointer'>
          -
        </button>
        ...
        <button onClick={handleIncrease} className='px-3 py-1 bg-gray-300 text-gray-800 rounded-r hover:bg-gray-400 cursor-pointer'>
          +
        </button>
      </div>
    </div>
